...
XBPS_ARCH="$arch"-musl xbps-install -Suvy -r /mnt -R "$repo"/musl base-system pam-mount opendoas pigz micro moar iwd
...
XBPS_ARCH="$arch" xbps-install -Suvy -r /mnt/glibc -R "$repo" -S base-voidstrap
